  ...
  return (
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
      <View style={styles.container}>
        ...
        <Text className="-top-11 justify-center -left-3" style={styles.formFooter}>
                 Téléchargez votress photo*
          </Text>
          <Text style={styles.listTitle}>
                  Complete votresss  <Text style={{ color: '#f4405b' }}>formulaire</Text>
          </Text>
        ...
        <View style={styles.form} className=" -top-1">
          <View >
            <View>
              <Dropdown 
