      ...
      <ScrollView
        ...
        <View style={styles.hero}>
          ...
          <View style={styles.heroStatus}>
            <Text style={styles.heroStatusText}>Ajouter photo d'article</Text>
          </View>
        </View>
        <View style={styles.header}>
          <View style={styles.headerTop}>
            <Text style={styles.title}>Arthur's Pizza </Text>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.categories}>
            <View style={styles.categoriesHeader}>
              <Text style={styles.categoriesTitle}>Menu Paramètres</Text>
            ...
            <ScrollView
              ...
              {[
                {
                  img: 'https://www.icone-png.com/png/44/44044.png',
                  label: 'Soldes',
                  color: '#F7EDD0',
                },
                {
                  img: 'https://www.icone-png.com/png/35/34830.png',
                  label: 'Editer',
                  color: '#F1DFC5',
                },
                {
                ...
                {
                  img: 'https://www.icone-png.com/png/30/30164.png',
                  label: 'supprimer',
                  color: '#F7C5BA',
                },
